...
console.log('The velociraptor diet was' , velociraptor.diet);

// How long was a stegosaurus?
console.log('The stegosaurus length was' , stegosaurus.length);
...
console.log('The tyrannosaurus goes', tyrannosaurus.roar());
...
zooAnimals.forEach(element => {
  animalNames.push(`Name: ${element.animal_name}, ${element.scientific_name}`);
});
